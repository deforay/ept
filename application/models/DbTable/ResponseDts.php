        ...
        try {
            foreach ($sampleIds as $key => $sampleId) {
                ...
                $data = array(
                    ...
                    'qc_date_1' => Pt_Commons_DateUtility::isoDateFormat($params['qc_date_1']),
                    'repeat_qc_done_1' => $params['repeat_qc_done_1'] ?? null,
                    'repeat_qc_date_1' => Pt_Commons_DateUtility::isoDateFormat($params['repeat_qc_date_1']),
                    'qc_done_2' => $params['qc_done_2'] ?? null,
                    'qc_date_2' => Pt_Commons_DateUtility::isoDateFormat($params['qc_date_2']),
                    'repeat_qc_done_2' => $params['repeat_qc_done_2'] ?? null,
                    'repeat_qc_date_2' => Pt_Commons_DateUtility::isoDateFormat($params['repeat_qc_date_2']),
                    'qc_done_3' => $params['qc_done_3'] ?? null,
                    'qc_date_3' => Pt_Commons_DateUtility::isoDateFormat($params['qc_date_3']),
                    'repeat_qc_done_3' => $params['repeat_qc_done_3'] ?? null,
                    'repeat_qc_date_3' => Pt_Commons_DateUtility::isoDateFormat($params['repeat_qc_date_3']),
