        ...
        foreach($sampleIds as $key => $sampleId){
            ...
            if($res == null || count($res) == 0){
                $this->insert(array(
                    ...
                    'test_kit_name_3'   => $params['test_kit_name_3'],
                    'lot_no_3'          => (isset($params['dtsData']->Heading3->data->lot[2]) && $params['dtsData']->Heading3->data->lot[2] != '')?$params['dtsData']->Heading3->data->lot[2]:'',
                    'exp_date_3'        => (isset($params['dtsData']->Heading3->data->expDate[2]) && $params['dtsData']->Heading3->data->expDate[2] != '')?date('Y-m-d',strtotime($params['dtsData']->Heading3->data->expDate[2])):'',
