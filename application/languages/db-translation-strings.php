...
// r_modes_of_receipt.mode_name
_('Online Response');
// r_network_tiers.network_name, r_response_not_tested_reasons.ntr_reason, r_response_vl_not_tested_reason.vl_not_tested_reason, r_site_type.site_type
_('Other');
// r_response_vl_not_tested_reason.vl_not_tested_reason
...
_('Please ensure all critical fields are reported in your PT Result Form');
// r_dts_corrective_actions.corrective_action, r_dts_corrective_actions.description
...
// r_dts_corrective_actions.corrective_action
_('Review and refer to National HIV Testing Algorithms for result interpretation as final result interpretation does not match the expected result.');
// r_dts_corrective_actions.corrective_action
_('Review and Refer to SOP for testing. Investigate possible causes such as : (1) sample mix-up, (2) incorrect sample volume used, (3) interpreting the result before and after the manufacturer recommended time');
// r_covid19_corrective_actions.corrective_action
...
_('very low');
// r_response_vl_not_tested_reason.vl_not_tested_reason
_('Viral Load Machine not working');
// r_possibleresult.response
_('WEAK REACTIVE');
// r_possibleresult.response
_('weak reactive');
