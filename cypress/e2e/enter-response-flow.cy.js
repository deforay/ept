  ...
  it("should automate the web app", function () {
    ...
    cy.get("[name='sampleId[]']").each(($el, index, $list) => {
      ...
      .then((val) => {
        ...
        cy.get("#sampleRow"+val+" [name='spc[]']").type((index+1)+".23");
        cy.get("#sampleRow"+val+" [name='ISI[]']").type((index+1)+"2.24");
        cy.get("#sampleRow"+val+" [name='rpoB1[]']").type((index+1)+"3.25");
        cy.get("#sampleRow"+val+" [name='rpoB2[]']").type((index+1)+"4.26");
        cy.get("#sampleRow"+val+" [name='rpoB3[]']").type((index+1)+"5.27");
        cy.get("#sampleRow"+val+" [name='rpoB4[]']").type((index+1)+"6.28");
