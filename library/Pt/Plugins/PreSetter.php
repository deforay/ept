...
class Pt_Plugins_PreSetter extends Zend_Controller_Plugin_Abstract {
    ...
    public function preDispatch(Zend_Controller_Request_Abstract $request) {
        ...
        if ($request->getModuleName() == 'default'  && $request->getControllerName() != 'auth'  && $request->getControllerName() != 'error' && $request->getControllerName() != 'index' && $request->getControllerName() != 'captcha' && $request->getControllerName() != 'contact-us' && $request->getControllerName() != 'common') {
