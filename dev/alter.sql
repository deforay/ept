...
--  Thana 6 Jul, 2020
ALTER TABLE `data_manager` ADD `push_status` VARCHAR(50) NULL DEFAULT 'not-sent' AFTER `push_notify_token`;
--  Thana 7 Jul, 2020
...
--  Amit 20-July-2021
UPDATE `shipment_participant_map` set shipment_test_date = null WHERE IFNULL(is_pt_test_not_performed, 'no') = 'yes';
...
-- Thana 18-Aug-2023
INSERT INTO `r_possibleresult` (`id`, `scheme_id`, `scheme_sub_group`, `response`, `result_code`) VALUES
(NULL, 'tb', 'TB_MOLECULAR_FINAL', 'LOW', 'low'),
(NULL, 'tb', 'TB_MOLECULAR_FINAL', 'VERY LOW', 'very-low'),
...
ALTER TABLE `response_result_tb` CHANGE `spc` `spc_xpert` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL;
ALTER TABLE `response_result_tb` ADD `spc_xpert_ultra` VARCHAR(50) NULL DEFAULT NULL AFTER `spc_xpert`;
ALTER TABLE `reference_result_tb` CHANGE `spc` `spc_xpert` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL;
...
-- Thana 13-Dec-2023
ALTER TABLE `r_testkitname_dts` ADD `additional_info` VARCHAR(50) NULL DEFAULT '0' AFTER `CountryAdapted`;
